...
resp = requests.post("http://127.0.0.1:5000/member_update", json={"name":'阿洪洪', "password":'12345', 'allergy':['綠油精'], 'bag':[{'藥袋A':[{'startDate':'2022-12-08'},{'endDate':'2022-12-09'}]}, {'藥袋B':[{'startDate':'2022-12-08'},{'endDate':'2022-12-10'}]}, {'藥袋C':[{'startDate':'2022-12-08'},{'endDate':'2022-12-11'}]}]})
...
# resp = requests.post("http://127.0.0.1:5000/search_schedule", json={"date":'2022-12-11'})
