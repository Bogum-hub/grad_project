...
####################### 會員資料相關 ###########################
# resp = requests.post("http://127.0.0.1:5000/register", json={"username":'阿洪',"account":'iiidddddiuuyy@gmail.com', "password":'123456', 'allergy':[{'drug':'綠油精'}, {'drug':'暈速寧片'}], 'bag':[{'藥袋A':[{'startDate':'2022-12-08'},{'endDate':'2022-12-09'}]}, {'藥袋B':[{'startDate':'2022-12-08'},{'endDate':'2022-12-10'}]}, {'藥袋C':[{'startDate':'2022-12-08'},{'endDate':'2022-12-11'}]}]})
...
####################### 用藥時程相關 ###########################
# resp = requests.post("http://127.0.0.1:5000/create_schedule", json={"drug": '綠油精', "startDate": '2019-12-11', "endDate": '2019-12-10', "duration": '3', "daily": '09:00', "bag": '藥袋c', "hint": '1'})
...
# resp = requests.post("http://127.0.0.1:5000/search_schedule", json={"date":'2019-12-07'})
# resp = requests.get("http://127.0.0.1:5000/search_schedule")
# resp = requests.post("http://127.0.0.1:5000/search_schedule_mon", json={"date":'202102', "year":2021, "mon":2})
